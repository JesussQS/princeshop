...
namespace princeshop.Controllers
{
    public class ProductoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Descripcion,Precio,Temporada,Sexo,ImageName,Status")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Descripcion,Precio,Temporada,Sexo,ImageName,Status")] Producto producto)
        {
            if (id != producto.Id)
            {
                return NotFound();
